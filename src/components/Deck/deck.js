...
class Deck extends Component {
    constructor(props, context) {
        ...
        this.onSwitchStarted = this.onSwitchStarted.bind(this);
        this.onSwitchStopped = this.onSwitchStopped.bind(this);
        this.onSwitchPaused = this.onSwitchPaused.bind(this);
    ...
    render() {
        ...
        props.className = cx('verticalDeck', props.className);
        return (
            <div {...props}>
                {this.renderSlides()}
            </div>
